        ...
        if (isNeedCamera && position == 0) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    boolean isGranted = EasyPermissions.hasPermissions(mContext, "android.permission.CAMERA");
                    if (isGranted) {
                        ...
                        if(mContext instanceof Activity){
                            EasyPermissions.requestPermissions((Activity) mContext, "需要摄像头权限", BaseActivity.RC_READ_CAMERA, "android.permission.CAMERA");
                        }
                    }
                }
            });
