...
import com.beyond.library.sharesdk.CustomerLogo;
import com.beyond.library.sharesdk.ShareSdkConfig;
import com.beyond.library.sharesdk.shareInfo.BaseShareFields;
import com.beyond.library.sharesdk.theme.classic.ViewPagerClassic;
...
//	private HashMap<String, Object> reqData;
    private HashMap<String, BaseShareFields> reqData;
    ...
    private void init(final Context context) {
        ...
        new Thread() {
            public void run() {
                try {
                    platformList = ShareSdkConfig.getInstance().getDefaultPlatforms();//ShareSDK.getPlatformList();
...
//		}
    ...
    public void setData(HashMap<String, BaseShareFields> data, boolean silent) {
        reqData = data;
        this.silent = silent;
    }
    ...
    public void onClick(View v) {
        ...
        platforms.add((Platform) v.getTag());
    ...
    private static class PlatformAdapter extends ViewPagerAdapter {
        ...
        public PlatformAdapter(PlatformGridView platformGridView) {
            ...
            Platform[] platforms = ShareSdkConfig.getInstance().getDefaultPlatforms();//platformGridView.platformList;
    ...
    private static class GridView extends LinearLayout {
        ...
        private LinearLayout getView(int position, OnClickListener ocL, Context context) {
            ...
            if(label != null){
                ...
                lpTv.weight = 1;
                lpTv.setMargins(dp_5, 0, dp_5, dp_5 * 2);
