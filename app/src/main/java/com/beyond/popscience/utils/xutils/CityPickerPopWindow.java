...
public class CityPickerPopWindow extends PopupWindow implements OnWheelChangedListener {
    static final String TAG = "CityPickerPopWindow";
    ...
    private String DEFAULT_PICKVALUE = "安徽省-安庆市-枞阳县";
    private String pickValue = DEFAULT_PICKVALUE;
    ...
    private TextView closePopWindow;
    ...
    private void setUpListener(View cityPickerView) {
        closePopWindow = (TextView) cityPickerView.findViewById(R.id.closePop);
        showValue = (TextView) cityPickerView.findViewById(R.id.showValue);
    ...
    private void updateAreas() {
        ...
        Log.d(TAG, "[updateAreas] .. city == " + mCurrentCityName + ",mCurrentDistrictName == " + mCurrentDistrictName);
    ...
    public void onChanged(WheelView wheel, int oldValue, int newValue) {
        if (wheel == mViewProvince) {
            ...
            mCurrentZipCode = mZipcodeDatasMap.get(mCurrentDistrictName);
            Log.d(TAG, "city == " + mCurrentCityName + ",mCurrentDistrictName == " + mCurrentDistrictName);
        }
        pickValue = mCurrentProviceName + divider + mCurrentCityName + divider + mCurrentDistrictName;
//        pickValue = mCurrentProviceName  + mCurrentCityName  + mCurrentDistrictName;
    }
