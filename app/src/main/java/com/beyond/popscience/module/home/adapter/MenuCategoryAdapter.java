...
import com.beyond.popscience.module.point.PointDetailActivity;
...
public class MenuCategoryAdapter extends CustomRecyclerBaseAdapter<MyMenu> {
    ...
    public MenuCategoryAdapter(Fragment fragment) {
        super(fragment);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHolder.itemMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (getDataList().get(position).getType() == 3) {
                    ...
                    if (24 == tabId) {
                        Intent intent = new Intent(context, ServiceTwoFragment.class);
        ...
        if (position==dataList.size()-1){
                viewHolder.img.setBackgroundResource(R.drawable.icon_social_blue);
        }else{
            Glide.with(context).load(getDataList().get(position).getTabpic()).error(R.drawable.icon_social_blue).placeholder(R.drawable.icon_social_blue).into(viewHolder.img);
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_menus_two, parent, false);
