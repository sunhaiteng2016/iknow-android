...
public class NewsListNoMenuFragment extends BaseFragment {
    ...
    public static NewsListNoMenuFragment getInstance(NavObj nav) {
        NewsListNoMenuFragment fragment = new NewsListNoMenuFragment();
    ...
    public static NewsListNoMenuFragment getInstance(NavObj nav, int type) {
        NewsListNoMenuFragment fragment = new NewsListNoMenuFragment();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (isTownAnnouncement()) {   //乡镇公告
                    AnnouncementActivity.startActivity(NewsListNoMenuFragment.this, news);
                } else {
                    if (isTownNews()) {//是否是乡镇新闻
                        NewsDetailActivity.startActivity(NewsListNoMenuFragment.this, news, true);
                    } else if (news.newsStyle == 5) {
                        //跳转到 外链
                        X5WebViewActivity.startActivity(getActivity(), news.link, news.title);
                    } else {
                        NewsDetailActivity.startActivity(NewsListNoMenuFragment.this, news, false);
                    }
                }
