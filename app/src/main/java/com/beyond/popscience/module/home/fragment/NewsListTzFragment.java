...
public class NewsListTzFragment extends BaseFragment {
    ...
    public static NewsListTzFragment getInstance(NavObj nav) {
        NewsListTzFragment fragment = new NewsListTzFragment();
    ...
    public static NewsListTzFragment getInstance(NavObj nav, int type) {
        NewsListTzFragment fragment = new NewsListTzFragment();
    ...
    public void initUI() {
        ...
        mListView.getRefreshableView().setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));

        mNewsAdapter = new newListRecyViewAdapter(this);
        mNewsAdapter.setReaded(newsReaded);
        mListView.getRefreshableView().setAdapter(mNewsAdapter);
        mListView.setOnReadyForPullListener(new PullToRefreshRecycleView.OnReadyForPullListener() {
            @Override
        ...
        mNewsAdapter.setOnItemClickListener(new CustomRecyclerBaseAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(RecyclerView.ViewHolder holder, int position, long id) {
                ...
                if (isTownAnnouncement()) {   //乡镇公告
                    AnnouncementActivity.startActivity(NewsListTzFragment.this, news);
                } else {
                    if (isTownNews()) {//是否是乡镇新闻
                        NewsDetailActivity.startActivity(NewsListTzFragment.this, news, true);
                    } else if (news.newsStyle == 5) {
                        //跳转到 外链
                        X5WebViewActivity.startActivity(getActivity(), news.link, news.title);
                    } else {
                        NewsDetailActivity.startActivity(NewsListTzFragment.this, news, false);
                    }
                }
...
//                        }
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_news_list_recy_list;
    }
