...
public class NewTownFragment extends BaseFragment {

    /**
     *
     */
    private final TabEntity[] TABS = {
            new TabEntity("最新消息", 0, 0),
            new TabEntity("通知公告", 0, 0),
            new TabEntity("交流", 0, 0),
    ...
    public static NewTownFragment getInstance() {
        NewTownFragment fragment = new NewTownFragment();
    ...
    public void initUI() {
        ...
        if (null == seletAddress) {
            ...
            if (currAddress == null) {
                ...
                currAddress = a;
                //currAddress = Address.assembledAddress(firstParentAddress, (firstParentAddress.getChild() != null && firstParentAddress.getChild().size() != 0) ? firstParentAddress.getChild().get(0) : null);
            }
            setresultAddress();
    ...
    private void switchFragment(int index) {
        ...
        switch (index) {
            ...
            case 1: //公告
                ...
                getCarousel();
                currFragment = NewsListNoBannerFragment.getInstance(getNavObj(), News.TYPE_TOWN_ANNOUNCEMENT);
            ...
            case 3: //最新消息
               ...
               // viewpager.setCurrentItem(3);
                break;
            case 4: //最新消息
                currFragment = TownChengYuanFragment.getInstance(currAddress);
    ...
    public void toAddressSelect() {
        //TownCategoryActivity.startActivityForResult(this, currAddress, REUQEST_TOWN_ADDRESS_CODE);
