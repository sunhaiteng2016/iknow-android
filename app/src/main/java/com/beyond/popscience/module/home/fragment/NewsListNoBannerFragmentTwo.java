...
public class NewsListNoBannerFragmentTwo extends BaseFragment {
    ...
    public static NewsListNoBannerFragmentTwo getInstance(NavObj nav) {
        NewsListNoBannerFragmentTwo fragment = new NewsListNoBannerFragmentTwo();
    ...
    public static NewsListNoBannerFragmentTwo getInstance(NavObj nav, int type) {
        NewsListNoBannerFragmentTwo fragment = new NewsListNoBannerFragmentTwo();
        ...
        mNewsAdapter.setItemOnClick(new newListRecyViewAdapter.itemOnClick() {
            ...
            public void onMyClick(int position, View view) {
                ...
                if (isTownAnnouncement()) {   //乡镇公告
                    AnnouncementActivity.startActivity(NewsListNoBannerFragmentTwo.this, news);
                } else {
                    if (isTownNews()) {//是否是乡镇新闻
                        NewsDetailActivity.startActivity(NewsListNoBannerFragmentTwo.this, news, true);
                    } else if (news.newsStyle == 5) {
                        //跳转到 外链
                        X5WebViewActivity.startActivity(getActivity(), news.link, news.title);
                    } else {
                        NewsDetailActivity.startActivity(NewsListNoBannerFragmentTwo.this, news, false);
                    }
                }
