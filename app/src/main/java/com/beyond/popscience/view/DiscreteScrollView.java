...
public class DiscreteScrollView extends RecyclerView {
    ...
    private static final int DEFAULT_ORIENTATION = com.beyond.popscience.view.Orientation.HORIZONTAL.ordinal();
    ...
    private void init(AttributeSet attrs) {
        ...
        layoutManager = new DiscreteScrollLayoutManager(
                ...
                com.beyond.popscience.view.Orientation.values()[orientation]);
    ...
    public void setOrientation(com.beyond.popscience.view.Orientation orientation) {
