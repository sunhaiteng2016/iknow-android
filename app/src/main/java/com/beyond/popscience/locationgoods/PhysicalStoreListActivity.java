...
public class PhysicalStoreListActivity extends BaseActivity {
    ...
    private void initListView() {
        ...
        adapter = new CommonAdapter<ProductList>(this, R.layout.item_list_view_goods, list) {
            ...
            protected void convert(ViewHolder holder, ProductList s, int position) {
                Glide.with(PhysicalStoreListActivity.this).load(s.getPic()).into((ImageView) holder.getView(R.id.iv_img));
        ...
        adapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                Intent intent = new Intent(PhysicalStoreListActivity.this, GoodsDatesActivity.class);
