...
public class MapUtil {
    ...
    public static void openGaoDeNavi(Context context,double slat, double slon, String sname, String dname) {
        String uriString = null;
        StringBuilder builder = new StringBuilder("amapuri://route/plan?sourceApplication=applicationName");
            builder.append("&sname=").append(sname)
                    .append("&slat=").append(slat)
                    .append("&slon=").append(slon);
        builder
...
//            slon = originLatLng.longitude;
    ...
    public static void openBaiDuNavi(Context context, double dlat, double dlon, String sname, String dname) {
        String uriString = null;
        //终点坐标转换
//        此方法需要百度地图的BaiduLBS_Android.jar包
//        LatLng destination = new LatLng(dlat,dlon);
...
//            slon = originLatLng.longitude;
     ...
     /*   builder.append("origin=")
        ...
        builder.append("&destination=")
                .append(dname);
        builder.append("&mode=riding&src=科普中国户户通");
        uriString = builder.toString();
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setPackage(PN_BAIDU_MAP);
        intent.setData(Uri.parse(uriString));
