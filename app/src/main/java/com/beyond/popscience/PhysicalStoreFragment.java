...
import com.beyond.popscience.locationgoods.PhysicalStoreListActivity;
 ...
 * 实体店
 */
public class PhysicalStoreFragment extends BaseFragment implements OnLoadMoreListener, OnRefreshListener {
    ...
    private void initDateListView() {
        ...
        adapter = new CommonAdapter<ProductList>(getActivity(), R.layout.item_list_physical_store, lists) {
    ...
    private void initListView() {
        ...
        buttonAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                Intent intent = new Intent(getActivity(), PhysicalStoreListActivity.class);
