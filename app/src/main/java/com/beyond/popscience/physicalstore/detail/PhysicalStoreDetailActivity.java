...
public class PhysicalStoreDetailActivity extends BaseActivity implements AddWidget.OnAddClick {
	...
	private void initRecyclerView() {
		...
		View header = View.inflate(this, R.layout.item_detail_header, null);
		dAdapter.addHeaderView(header);
		TextView footer = new TextView(this);
		ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewUtils.dip2px(this, 100));
	...
	private void initShopCar() {
		...
		flist.addAll(ShopMainActivity.carAdapter.getData());
	...
	private void dealCar(FoodBean foodBean) {
		...
		Intent intent = new Intent(ShopMainActivity.CAR_ACTION);
	...
	private class SpaceItemDecoration extends RecyclerView.ItemDecoration {
		...
		SpaceItemDecoration() {
			this.space = ViewUtils.dip2px(PhysicalStoreDetailActivity.this, 2);
		}
	...
	public void clearCar(View view) {
		ViewUtils.showClearCar(PhysicalStoreDetailActivity.this, new DialogInterface.OnClickListener() {
			@Override
