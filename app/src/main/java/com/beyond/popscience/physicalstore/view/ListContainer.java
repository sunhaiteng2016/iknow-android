package com.beyond.popscience.physicalstore.view;
...
import com.beyond.popscience.physicalstore.detail.PhysicalStoreDetailActivity;
		...
		recyclerView2.addOnItemTouchListener(new OnItemClickListener() {
			...
			public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
				...
				if (view.getId() == R.id.food_main) {
					Intent intent = new Intent(mContext, PhysicalStoreDetailActivity.class);
