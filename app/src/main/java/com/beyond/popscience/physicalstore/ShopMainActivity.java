package com.beyond.popscience.physicalstore;
...
import com.beyond.popscience.physicalstore.adapters.CarAdapter;
import com.beyond.popscience.physicalstore.bean.FoodBean;
import com.beyond.popscience.physicalstore.behaviors.AppBarBehavior;
import com.beyond.popscience.physicalstore.detail.ShopDetailActivity;
import com.beyond.popscience.physicalstore.fragments.FirstFragment;
import com.beyond.popscience.physicalstore.fragments.SecondFragment;
import com.beyond.popscience.physicalstore.utils.ViewUtils;
import com.beyond.popscience.physicalstore.view.AddWidget;
import com.beyond.popscience.physicalstore.view.ShopCarView;
import com.beyond.popscience.physicalstore.view.ShopInfoContainer;
...
public class ShopMainActivity extends BaseActivity implements AddWidget.OnAddClick {
...
//		carRecView.setNestedScrollingEnabled(false);
    ...
    public void toShopDetail(View view) {
        ...
        if (android.os.Build.VERSION.SDK_INT > 20) {
            startActivity(new Intent(mContext, ShopDetailActivity.class), ActivityOptions.makeSceneTransitionAnimation(ShopMainActivity.this, shopInfoContainer.iv_shop, "transitionShopImg").toBundle());
        } else {
