...
public class WheelView extends View {
    ...
    public void setViewBackgroundColor(int color){
        ...
        topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, new int[]{color, color});
        bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, new int[]{color, color});
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(valuePaint.getTextSize() != TEXT_SIZE * systemFontScale){
            valuePaint.setTextSize(TEXT_SIZE * systemFontScale);
        }
