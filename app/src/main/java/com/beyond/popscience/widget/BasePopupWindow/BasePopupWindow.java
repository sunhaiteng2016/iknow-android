package com.beyond.popscience.widget.BasePopupWindow;
...
import com.beyond.popscience.widget.BasePopupWindow.utils.InputMethodUtils;
...
public abstract class BasePopupWindow implements ViewCreate
{
	...
	{
		initView( context, ViewGroup.LayoutParams.MATCH_PARENT,
	...
	public Animation getShowAnimation(){ return null; }
	...
	private void tryToShowPopup(int res, View v) throws Exception
	{
		...
		{
			mPopupWindow
				.showAtLocation( mContext.findViewById( android.R.id.content ), Gravity.CENTER, 0,
					0 );
		}
		...
		if(mDismissView!=null)
		{
			mDismissView.clearAnimation();
			mDismissView.startAnimation( getDefaultAlphaAnimation() );
		}
	}
	...
	public void dismiss()
	{
		try
		{
			...
			{
				mDismissView.clearAnimation();
				mDismissView.startAnimation( getDefaultExitAlphaAnimation() );
			}
		} catch(Exception e)
		{
