...
//        messageList.setAvatarShape(1);
                ...
                switch (msg.what) {
                    case MSG_TYPING_BEGIN: // Notify typing start
                        ...
                        if (hasMessages(MSG_TYPING_END)) {
                            ...
                            beginMsg.setAttribute("nickname","小明");
    ...
    private void showCard() {
        //发送扩展消息
        EMMessage message = EMMessage.createTxtSendMessage("社团分享",toChatUsername);
        //增加自己的属性
        message.setAttribute("associationCards",true);
        message.setAttribute("userHead","");
        message.setAttribute("userName","");
        message.setAttribute("type","Share");
        message.setAttribute("title","说说转发");
        message.setAttribute("content","");
        message.setAttribute("image","");
        message.setAttribute("articleId","");
